---
title: Quick Start
description: Create and publish your first Cedarville app.
...
- Sign in with your Cedarville account.
- Have a short app name and a one- or two-sentence description ready.
- Know who should be able to use the app. You can add coworkers later.
...
| --- | --- |
| GitHub repository | The private, managed online folder that stores the app's code and change history. |
| Publish | Send the current code to Azure so people can use the app in a web browser. |
| Azure | Microsoft's hosting service where the running app lives. |
