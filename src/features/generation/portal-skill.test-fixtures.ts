...
const PREVIOUS_CUSTOM_SIGN_IN_GUIDANCE = "- When adding a custom sign-in route, leave that exact route and the required Entra callback route anonymous. The portal must not depend on that route's path for deployment verification.\n";
